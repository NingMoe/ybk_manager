		...
		internal partial class CoderInvoker : Coder {
			...
			public override unsafe int MaxOutputSize (int p0)
			{
				...
				try {
					...
					return JNIEnv.CallIntMethod  (Handle, id_maxOutputSize_I, __args);
				} finally {
				}
			}
			...
			public override unsafe bool Process (byte[] p0, int p1, int p2, bool p3)
			{
				...
				try {
					...
					bool __ret = JNIEnv.CallBooleanMethod  (Handle, id_process_arrayBIIZ, __args);
					return __ret;
				} finally {
					if (p0 != null) {
				...
				: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
			{
				...
				try {
					...
					if (GetType () != typeof (Decoder)) {
						...
						global::Android.Runtime.JNIEnv.FinishCreateInstance (Handle, "(I[B)V", __args);
						return;
					}
					...
					SetHandle (
							...
							JniHandleOwnership.TransferLocalRef);
					JNIEnv.FinishCreateInstance (Handle, class_ref, id_ctor_IarrayB, __args);
				} finally {
					if (p1 != null) {
			...
			public override unsafe int MaxOutputSize (int p0)
			{
				...
				try {
					...
					if (GetType () == ThresholdType)
						...
						return JNIEnv.CallNonvirtualIntMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "maxOutputSize", "(I)I"), __args);
				} finally {
				}
			}
...
#pragma warning restore 0169
			...
			public override unsafe bool Process (byte[] p0, int p1, int p2, bool p3)
			{
				...
				try {
					...
					bool __ret;
					if (GetType () == ThresholdType)
						__ret = JNIEnv.CallBooleanMethod  (Handle, id_process_arrayBIIZ, __args);
					else
						__ret = JNIEnv.CallNonvirtualBooleanMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "process", "([BIIZ)Z"), __args);
					return __ret;
				} finally {
					if (p0 != null) {
						JNIEnv.CopyArray (native_p0, p0);
