		...
		public sealed partial class MySharedPreferencesImpl : global::Java.Lang.Object, global::Com.TA.Utdid2.Core.Persistent.IMySharedPreferences {
					...
					: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
				{
					...
					try {
						...
						SetHandle (
								...
								JniHandleOwnership.TransferLocalRef);
						JNIEnv.FinishCreateInstance (Handle, class_ref, id_ctor_Lcom_ta_utdid2_core_persistent_TransactionXMLFile_MySharedPreferencesImpl_, __args);
					} finally {
					}
				}
			...
			public unsafe bool HasFileChanged {
				...
				get {
					...
					try {
						return JNIEnv.CallBooleanMethod  (Handle, id_hasFileChanged);
					} finally {
					}
				}
			}
			...
			public unsafe void Replace (global::System.Collections.IDictionary p0)
			{
				...
				try {
					JValue* __args = stackalloc JValue [1];
					__args [0] = new JValue (native_p0);
					JNIEnv.CallVoidMethod  (Handle, id_replace_Ljava_util_Map_, __args);
				} finally {
					JNIEnv.DeleteLocalRef (native_p0);
				}
			}
			...
			public unsafe void SetHasChange (bool p0)
			{
				...
				try {
					JValue* __args = stackalloc JValue [1];
					__args [0] = new JValue (p0);
					JNIEnv.CallVoidMethod  (Handle, id_setHasChange_Z, __args);
				} finally {
				}
			}
		...
		public virtual unsafe global::Com.TA.Utdid2.Core.Persistent.IMySharedPreferences GetMySharedPreferences (string p0, int p1)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					__ret = global::Java.Lang.Object.GetObject<global::Com.TA.Utdid2.Core.Persistent.IMySharedPreferences> (JNIEnv.CallObjectMethod  (Handle, id_getMySharedPreferences_Ljava_lang_String_I, __args), JniHandleOwnership.TransferLocalRef);
				else
					__ret = global::Java.Lang.Object.GetObject<global::Com.TA.Utdid2.Core.Persistent.IMySharedPreferences> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getMySharedPreferences", "(Ljava/lang/String;I)Lcom/ta/utdid2/core/persistent/MySharedPreferences;"), __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
				JNIEnv.DeleteLocalRef (native_p0);
			}
